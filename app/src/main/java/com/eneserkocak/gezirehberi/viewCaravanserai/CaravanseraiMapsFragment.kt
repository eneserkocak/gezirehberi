...
import com.eneserkocak.gezirehberi.databinding.FragmentCaravanseraiMapsBinding
...
class CaravanseraiMapsFragment : BaseFragment<FragmentCaravanseraiMapsBinding>(R.layout.fragment_caravanserai_maps),OnMapReadyCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sharedPreferences = requireActivity().getSharedPreferences("com.eneserkocak",
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        viewModel.selectedFavoriteCaravanserai.observe(viewLifecycleOwner) { caravanserai->
            caravanserai?.let {
                mMap.addMarker(MarkerOptions().position(LatLng(it.favoriteCaravanseraiLat,it.favoriteCaravanseraiLong)).title(it.favoriteCaravanseraiName)                    )
                mMap.moveCamera(
                    CameraUpdateFactory.newLatLngZoom(
                        LatLng(it.favoriteCaravanseraiLat,it.favoriteCaravanseraiLong), 12f))
            }
        }
